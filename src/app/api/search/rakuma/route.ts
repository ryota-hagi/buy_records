...
import { RakumaSeleniumScraper } from '@/collectors/rakuma_selenium';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const scraper = new RakumaSeleniumScraper(seleniumUrl);
    ...
    try {
      ...
      console.log(`ラクマ検索完了: ${limitedResults.length}件`);
      ...
      console.error('ラクマスクレイピングエラー:', scraperError);
